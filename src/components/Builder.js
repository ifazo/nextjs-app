import { clearProducts } from "@/store/features/Product";
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <div className="text-gray-900">CPU</div>
                    ...
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <div className="text-gray-900">Motherboard</div>
                        <div className="text-gray-500">Required</div>
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        $250
                    ...
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <div className="text-gray-900">RAM</div>
                        <div className="text-gray-500">Required</div>
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        $250
                    ...
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <div className="text-gray-900">Power Supply Unit</div>
                        <div className="text-gray-500">Required</div>
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        $250
                    ...
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <div className="text-gray-900">Storage Device</div>
                        <div className="text-gray-500">Required</div>
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        $250
                    ...
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <div className="text-gray-900">Monitor</div>
                        <div className="text-gray-500">Required</div>
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        $250
